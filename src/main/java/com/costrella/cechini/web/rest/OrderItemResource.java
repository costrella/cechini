...
/**
 * REST controller for managing {@link com.costrella.cechini.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
public class OrderItemResource {
    ...
    public ResponseEntity<List<OrderItemDTO>> getByOrderId(Pageable pageable, @PathVariable Long orderId) {
