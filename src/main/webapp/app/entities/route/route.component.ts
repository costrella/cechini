...
export class RouteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.routeService
      ...
      .subscribe(
        (res: HttpResponse<IRoute[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInRoutes(): void {
    this.eventSubscriber = this.eventManager.subscribe('routeListModification', () => this.loadPage());
  }
