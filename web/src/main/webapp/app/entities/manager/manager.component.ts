...
export class ManagerComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.managerService
      ...
      .subscribe(
        (res: HttpResponse<IManager[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInManagers(): void {
    this.eventSubscriber = this.eventManager.subscribe('managerListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IManager[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
